 ...
 * @author Mario Pirau
 */
public class VisibleFieldNotFoundException extends InvalidCsvException {

    public VisibleFieldNotFoundException(long rowNumber, String columnName, String message) {
